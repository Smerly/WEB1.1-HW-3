...
# compliment = choice(list_of_compliments)
...
def compliments_results():
    ...
    list_compliments = random.sample(list_of_compliments, int(num_compliments))

    context = {
        # TODO: Enter your context variables here.
        'users_name': request.args.get('users_name'),
        # 'compliment_output': compliment_output,
        # 'compliment': compliment,
        'wants_compliments': request.args.get('wants_compliments'),
        'list_compliments': list_compliments
...
def animal_facts():
    ...
    context = {
        ...
        'animal': animal,
        'animal_type': animal_to_fact.keys(),
        'animal_fact': animal_to_fact
